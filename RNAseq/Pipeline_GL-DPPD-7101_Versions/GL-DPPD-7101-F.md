...
- **raw_multiqc_GLbulkRNAseq.html** (multiqc report)
- **/raw_multiqc_GLbulkRNAseq_data** (directory containing multiqc data)
...
- **trimmed_multiqc_GLbulkRNAseq.html** (multiqc report)
- **/trimmed_multiqc_GLbulkRNAseq_data** (directory containing multiqc data)
...
```bash
multiqc --interactive -n align_multiqc_GLbulkRNAseq -o /path/to/aligned_multiqc/output/directory /path/to/*Log.final.out/files
```
...
- **align_multiqc_GLbulkRNAseq.html** (multiqc report)
- **/align_multiqc_GLbulkRNAseq_data** (directory containing multiqc data)
...
- **infer_exp_multiqc_GLbulkRNAseq.html** (multiqc report)
- **/infer_exp_multiqc_GLbulkRNAseq_data** (directory containing multiqc data)
...
- **geneBody_cov_multiqc_GLbulkRNAseq.html** (multiqc report)
- **/geneBody_cov_multiqc_GLbulkRNAseq_data** (directory containing multiqc data)
...
```bash
multiqc --interactive -n inner_dist_multiqc_GLbulkRNAseq /path/to/inner_dist_multiqc/output/directory /path/to/inner_dist/output/files
```
...
- **inner_distance_multiqc_GLbulkRNAseq.html** (multiqc report)
- **/inner_distance_multiqc_GLbulkRNAseq_data** (directory containing multiqc data)
...
- **read_dist_multiqc_GLbulkRNAseq.html** (multiqc report)
- **/read_dist_multiqc_GLbulkRNAseq_data** (directory containing multiqc data)
...
- **RSEM_count_multiqc_GLbulkRNAseq.html** (multiqc report)
- **/RSEM_count_multiqc_GLbulkRNAseq_data** (directory containing multiqc data)
