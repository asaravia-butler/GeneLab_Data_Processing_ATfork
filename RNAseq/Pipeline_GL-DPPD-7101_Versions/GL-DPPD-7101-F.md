...
- **raw_multiqc_GLbulkRNAseq.html** (multiqc output html summaryt)
...
- **inner_distance_multiqc_GLbulkRNAseq.html** (multiqc output html summary)
- **/inner_distance_multiqc_GLbulkRNAseq_data** (directory containing multiqc output data)
